...
body{background:#0e1621;color:#fff;height:100dvh;overflow:hidden;
...
/* Основной интерфейс */
.sidebar{width:320px;background:#17212b;display:flex;flex-direction:column;border-right:1px solid #101921;min-height:0}
...
.main{flex:1;display:flex;flex-direction:column;background:#0e1621;min-height:0}
.mh{padding:12px 20px;background:#17212b;border-bottom:1px solid #101921;font-weight:600;font-size:15px}
.msgs{flex:1;overflow-y:auto;padding:20px;display:flex;flex-direction:column;gap:8px;min-height:0;-webkit-overflow-scrolling:touch;overscroll-behavior:contain}
...
@media(max-width:700px){.sidebar{width:100%;position:absolute;top:0;left:0;right:0;bottom:0;z-index:10;height:100dvh}
