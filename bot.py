...
VOICE_PRESETS = {
    ...
    "13": "equalizer=f=300:t=q:w=1:g=-20,equalizer=f=1200:t=q:w=1.5:g=10,equalizer=f=3500:t=q:w=1:g=-20,acompressor=threshold=-28dB:ratio=20:attack=2:release=25,acrusher=bits=6:mode=log:mix=0.4,volume=3.0",
}
VOICE_PRESET_NAMES = {
    "1":  "🎈 Мультяшный",
    "2":  "🤖 Робот",
