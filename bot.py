...
# ============ VOICEMOD ============
VOICE_PRESETS = {
    "1": (1.35, 0.74),   # Мультяшный — выше, скорость та же
    "2": (0.75, 1.33),   # Робот — ниже, скорость та же
    "3": (1.55, 0.65),   # Девочка — высокий, скорость та же
    "4": (0.55, 1.82),   # Демон — низкий, скорость та же
    "5": (1.55, 0.72),   # Бурундук — очень высокий, скорость та же
}
VOICE_PRESET_NAMES = {
    "1": "🎈 Мультяшный",
    "2": "🤖 Робот",
