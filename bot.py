...
VOICE_PRESETS = {
    ...
    "13": "asetrate=48000*0.92,aresample=48000,atempo=1.0869,highpass=f=400,lowpass=f=3000,acompressor=threshold=-15dB:ratio=8:attack=5:release=60,aecho=0.85:0.9:40|90:0.45|0.25,volume=1.5",
}
VOICE_PRESET_NAMES = {
    "1":  "🎈 Мультяшный",
    "2":  "🤖 Робот",
