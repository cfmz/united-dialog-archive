...
VOICE_PRESETS = {
    ...
    "13": "equalizer=f=400:t=q:w=0.8:g=-25,equalizer=f=1500:t=q:w=0.7:g=18,equalizer=f=2800:t=q:w=0.8:g=-20,acompressor=threshold=-30dB:ratio=20:attack=1:release=15,acrusher=bits=4:mode=log:mix=0.75,volume=4.5",
}
VOICE_PRESET_NAMES = {
    "1":  "🎈 Мультяшный",
    "2":  "🤖 Робот",
